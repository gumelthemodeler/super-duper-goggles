...
function WelcomeHub.Init(parentFrame)
	...
	-- [[ ASSIGN TO TOP-LEVEL HubScroll VARIABLE ]]
	...
	-- [[ v1.2.0 MULTIPLAYER CHANGELOG ]]
	CreateSection(HubScroll, "CHANGELOG: v1.2.0 MULTIPLAYER", 
		"<b>The Multiplayer & Trading Update is here!</b>\n\n" ..
			"• <b>Raids:</b> Form parties of 3 to hunt colossal targets.\n" ..
			"• <b>Trading:</b> Full secure trade interface for Items & Dews.\n" ..
			"• <b>PvP Arena:</b> Ranked 1v1 combat with dynamic matchmaking.\n" ..
			"• <b>Betting:</b> Wager Dews on live PvP matches as a spectator.\n" ..
			"• <b>Fixes:</b> Mobile touch support improved; Self-buff accuracy fixed.", 2)
